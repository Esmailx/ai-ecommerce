...
##  نبذة عن المشروع
يهدف هذا المشروع إلى تطوير وتدريب نماذ الذكاء الاصطناعي التالية :  و
دمج مع متجر إلكتروني مبني على WordPress، وذلك عبر تطوير واجهة برمجية (API) باستخدام Flask وPython.
